        ...
        <div class="box">
          <div class="box-header with-border"> 
            ...
            <div class="col-md-6">
              ...
              <router-link to="/10BesarPenyakitRI_RS/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
              ...
              <tbody>                  
                <tr>
                  <td>
                    ...
                    <button @click="reset()" type="button" class="btn btn-xs btn-danger"><i class="fa fa-fw fa-trash"></i>Hapus</button>
                  </td>
                  <td>{{ICD_RAWAT_INAP}}</td>
                  <td>{{NAMA_PENYAKIT_RAWAT_INAP}}</td>
                  <td>{{JUMLAH_KASUS_BARU_RAWAT_INAP}}</td>
                  <td>{{JUMLAH_KUNJUNGAN_RAWAT_INAP}}</td>
                </tr>               
              </tbody>
            </table>
          </div>
