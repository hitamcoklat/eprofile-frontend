        ...
        <div class="box">
          <div class="box-header with-border"> 
            <div class="alert alert-info alert-dismissible">
              ...
              <h4>Tabel 10 - JUMLAH POSYANDU DAN POSBINDU PTM</h4>
              <div class="row">
                <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table10/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th colspan="2" rowspan="2">Posyandu Aktif</th>
                  <th rowspan="3">Jumlah <br>Posbindu<br>PTM<br></th>
                </tr>
                <tr>
                  <td colspan="2">Pratama</td>
                  <td colspan="2">Madya</td>
                  <td colspan="2">Purnama</td>
