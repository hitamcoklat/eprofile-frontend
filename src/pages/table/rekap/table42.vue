    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <!-- Pilih Range Rekap -->
          <PilihRangeRekapPus linkPage="table42" @dataRekap="getRekapBtn" />         
          <!-- Pilih Range Rekap -->            
          </div>
          <!-- /.box-header -->
            ...
            <table id="dataTable" class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th style="vertical-align: middle; text-align: center;" colspan="3" rowspan="2">Jumlah Balita</th>
                  <th style="vertical-align: middle; text-align: center;" colspan="6">Pelayanan Kesehatan Balita<br></th>
                </tr>
                <tr>
              ...
              <tbody>                  
                <tr v-bind:key="item._id" v-for="(item, index) in listDesa">
                  ...
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].JUMLAH_BALITA_LAKI }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].JUMLAH_BALITA_PEREMPUAN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].JUMLAH_BALITA_LAKI_PEREMPUAN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PELAYANAN_KESEHATAN_BALITA_LAKI_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PELAYANAN_KESEHATAN_BALITA_LAKI_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PELAYANAN_KESEHATAN_BALITA_PEREMPUAN_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PELAYANAN_KESEHATAN_BALITA_PEREMPUAN_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PELAYANAN_KESEHATAN_BALITA_LAKI_PEREMPUAN_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PELAYANAN_KESEHATAN_BALITA_LAKI_PEREMPUAN_PERSEN }}</td>
                </tr> 
                <tr>
