    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <!-- Pilih Range Rekap -->
          <PilihRangeRekapPus linkPage="table63" @dataRekap="getRekapBtn" />         
          <!-- Pilih Range Rekap -->           
          </div>
          <!-- /.box-header -->
            ...
            <table id="dataTable" class="table table-hover table-bordered">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th style="vertical-align: middle; text-align: center;" colspan="3">KLB DI DESA/KELURAHAN</th>
                </tr>
                <tr>
                  <td style="vertical-align: middle; text-align: center;">JUMLAH</td>
                  <td style="vertical-align: middle; text-align: center;">DITANGANI &lt;24 JAM</td>
              ...
              <tbody>                  
                <tr v-bind:key="item._id" v-for="(item, index) in listDesa">
                  ...
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].JUMLAH_KLB_DI_DESA_KELURAHAN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].KLB_DESA_KELURAHAN_DITANGANI_KURANG_24_JAM }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PERSEN_KLN_DESA_KELURAHAN }}</td>
                </tr>
                <tr>
