        ...
        <div class="box">
          <div class="box-header with-border"> 
            <div class="alert alert-info alert-dismissible">
              ...
              <h4>Tabel 16 - JUMLAH TENAGA PENUNJANG/PENDUUNG KESEHATAN DI FASILITAS KESEHATAN</h4>
              <div class="row">
                <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table16/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th rowspan="3">Unit<br>Kerja<br></th>
                  <th colspan="12">Tenaga Penunjang/Pendukung Kesehatan</th>
                </tr>
                <tr>
                  <td colspan="3">Pejabat <br>Struktural</td>
                  <td colspan="3">Tenaga <br>Pendidik</td>
                  <td colspan="3">Tenaga Dukungan<br>Manajemen<br></td>
