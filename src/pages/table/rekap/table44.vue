    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <!-- Pilih Range Rekap -->
          <PilihRangeRekapPus linkPage="table44" @dataRekap="getRekapBtn" />         
          <!-- Pilih Range Rekap -->              
          </div>
          <!-- /.box-header -->
            ...
            <table id="dataTable" class="table table-striped">
              <thead class="thead-dark">
                <tr>
                    ...
                    <th style="vertical-align: middle; text-align: center;" rowspan="2">Jumlah Balita<br>0-59 Bulan<br>Yang Ditimbang<br></th>
                    <th style="vertical-align: middle; text-align: center;" colspan="2">Balita Gizi Kurang (BB/U)</th>
                    <th style="vertical-align: middle; text-align: center;" rowspan="2">Jumlah Balita<br>0-59 Bulan<br>Yang Diukur<br>Tinggi Badan<br></th>
                    <th style="vertical-align: middle; text-align: center;" colspan="2">Balita Pendek (TB/U)</th>
                    <th style="vertical-align: middle; text-align: center;" rowspan="2">Jumlah Balita<br>0-59 Bulan <br>Yang Diukur<br></th>
                    <th style="vertical-align: middle; text-align: center;" colspan="2">Balita Kurus (BB/TB)</th>
                  </tr>
                  <tr>
                ...
                <tbody>  
                  <tr v-bind:key="item._id" v-for="(item, index) in listDesa">
                    ...
                    <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].JUMLAH_BALITA_0_59_BULAN_YANG_DITIMBANG }}</td>
                    <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BALITA_GIZI_KURANG_JUMLAH }}</td>
                    <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BALITA_GIZI_KURANG_PERSEN }}</td>
                    <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].JUMLAH_BALITA_0_59_BULAN_YANG_DIUKUR_TINGGI_BADAN }}</td>
                    <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BALITA_PENDEK_JUMLAH }}</td>
                    <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BALITA_PENDEK_PERSEN }}</td>
                    <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].JUMLAH_BALITA_0_59_BULAN_YANG_DIUKUR }}</td>
                    <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BALITA_KURUS_JUMLAH }}</td>
                    <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BALITA_KURUS_PERSEN }}</td>
                  </tr>
                <tr>
