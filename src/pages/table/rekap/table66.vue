        ...
        <div class="box">
          <div class="box-header with-border"> 
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table66/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
          <div class="box-body table-responsive no-padding">
            <table class="table table-striped">
              <thead class="thead-dark">
                ...
                <tr>
                  <td rowspan="2">SUSPEK</td>
                  <td colspan="3">KONFIRMASI LABORATORIUM</td>
                  <td rowspan="2">% KONFIRMASI LABORATORIUM</td>
                  <td colspan="3">POSITIF</td>
                  <td rowspan="2">PENGOBATAN STANDAR</td>
                  <td rowspan="2">% PENGOBATAN STANDAR</td>
                ...
                <tr>
                  <td>MIKROSKOPIS</td>
                  <td>RAPIS DIAGNOSTIC TEST (RDT)</td>
                  <td>TOTAL</td>
                  <td>L</td>
                  <td>P</td>
                  <td>L + P</td>
