        ...
        <div class="box">
          <div class="box-header with-border"> 
            <div class="alert alert-info alert-dismissible">
              ...
              <h4>Tabel 9 - PERSENTASE PUSKESMAS DENGAN KETERSEDIAAN OBAT DAN VAKSIN ESENSIAL</h4>
              <div class="row">
                <div class="col-md-6">
            ...
            <div class="col-md-4">
              ...
              <router-link to="/table9/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th>Desa</th>
                  <th>Puskesmas</th>
                  <th>Ketersediaan Obat dan Vaksin Esensial</th>                    
                </tr>                                  
              </thead>
              <tbody>                  
                <tr>
