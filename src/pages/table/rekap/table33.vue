    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <!-- Pilih Range Rekap -->
          <PilihRangeRekapPus linkPage="table33" @dataRekap="getRekapBtn" />         
          <!-- Pilih Range Rekap -->             
          </div>
          <!-- /.box-header -->
            ...
            <table id="dataTable" class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th style="vertical-align: middle; text-align: center;" colspan="3" rowspan="2">Jumlah Lahir<br>Hidup<br></th>
                  <th style="vertical-align: middle; text-align: center;" colspan="6">Bayi Baru Lahir Ditimbang</th>
                  <th style="vertical-align: middle; text-align: center;" colspan="6">BBLR</th>
                </tr>
                <tr>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">L</td>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">P</td>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">L+P</td>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">L</td>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">P</td>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">L+P</td>
                </tr>
                <tr>
                  <td style="vertical-align: middle; text-align: center;">L<br></td>
                  <td style="vertical-align: middle; text-align: center;">P</td>
                  <td style="vertical-align: middle; text-align: center;">L+P<br></td>
              ...
              <tbody> 
                <tr v-bind:key="item._id" v-for="(item, index) in listDesa">
                  ...
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_BARU_LAHIR_DITIMBANG_LAKI_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_BARU_LAHIR_DITIMBANG_LAKI_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_BARU_LAHIR_DITIMBANG_PEREMPUAN_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_BARU_LAHIR_DITIMBANG_PEREMPUAN_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_BARU_LAHIR_DITIMBANG_LAKI_PEREMPUAN_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_BARU_LAHIR_DITIMBANG_LAKI_PEREMPUAN_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BBLR_LAKI_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BBLR_LAKI_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BBLR_PEREMPUAN_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BBLR_PEREMPUAN_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BBLR_LAKI_PEREMPUAN_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BBLR_LAKI_PEREMPUAN_PERSEN }}</td>
                </tr>  
                <tr>
