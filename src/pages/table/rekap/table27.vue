    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <!-- Pilih Range Rekap -->
          <PilihRangeRekapPus linkPage="table27" @dataRekap="getRekapBtn" />         
          <!-- Pilih Range Rekap -->            
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th style="vertical-align: middle; text-align: center;" rowspan="2">Jumlah Ibu<br>Hamil<br></th>
                  <th style="vertical-align: middle; text-align: center;" colspan="2">TTD (90 Tablet)<br></th>
                </tr>
                <tr>
              ...
              <tbody> 
                <tr v-bind:key="item._id" v-for="(item, index) in listDesa">
                  ...
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].TTD_90_TABLET_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].TTD_90_TABLET_PERSEN }}</td>
                </tr>
                <tr>
