        ...
        <div class="box">
          <div class="box-header with-border"> 
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table67/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
          <div class="box-body table-responsive no-padding">
            <table class="table table-striped">
              <thead class="thead-dark">
                ...
                <tr>
                  <td colspan="3">KASUS KRONIS TAHUN SEBELUMNYA</td>
                  <td colspan="3">KASUS KRONIS BARU DITEMUKAN</td>
                  <td colspan="3">KASUS KRONIS PINDAH</td>
                  <td colspan="3">KASUS KRONIS MENINGGAL</td>
                  <td colspan="3">JUMLAH SELURUH KASUS KRONIS</td>
                </tr>
                <tr>
                  <td>L</td>
                  <td>P</td>
