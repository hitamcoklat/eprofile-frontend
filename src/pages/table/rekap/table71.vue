        ...
        <div class="box">
          <div class="box-header with-border"> 
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table71/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th colspan="3">PELAYANAN KESEHATAN ODGJ BERAT</th>
                </tr>
                <tr>
                  <td rowspan="2">SASARAN ODGJ BERAT</td>
                  <td colspan="2">MENDAPAT PELAYANAN KESEHATAN</td>
                </tr>
                <tr>
                  <td>JUMLAH</td>
                  <td>%</td>
