        ...
        <div class="box">
          <div class="box-header with-border"> 
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table18/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
          <div class="box-body table-responsive no-padding">
            <table class="table table-striped">
              <thead class="thead-dark">
                ...
                <tr>
                  <td>Jumlah</td>
                  <td>Yang Memanfaatkan<br>Dana Desa Untuk<br>Kesehatan<br></td>
                  <td>Persen</td>
                </tr>                                   
              </thead>
              <tbody>                  
