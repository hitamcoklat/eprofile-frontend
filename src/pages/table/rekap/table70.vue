        ...
        <div class="box">
          <div class="box-header with-border"> 
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table70/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th rowspan="2">PUSKESMAS MELAKSANAKAN KEGIATAN DETEKSI DINI IVA &amp; SADANIS*</th>
                  <th rowspan="2">PEREMPUAN USIA 30-50 TAHUN</th>
                  <th colspan="2">PEMERIKSAAN LEHER RAHIM DAN PAYUDARA</th>
                  <th colspan="2">IVA POSITIF</th>
                  <th colspan="2">CURIGA KANKER</th>
