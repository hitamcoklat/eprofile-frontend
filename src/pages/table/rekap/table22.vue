    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <!-- Pilih Range Rekap -->
          <PilihRangeRekapPus linkPage="table22" @dataRekap="getRekapBtn" />         
          <!-- Pilih Range Rekap -->              
          </div>
          <!-- /.box-header -->
          <div class="box-body table-responsive no-padding">
            <table id="dataTable" class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  <th style="vertical-align: middle; text-align: center;" rowspan="2">Desa<br></th>
                  <th style="vertical-align: middle; text-align: center;" rowspan="2">Puskesmas</th>
                  <th style="vertical-align: middle; text-align: center;" colspan="6">Penyebab Kematian Ibu</th>
                </tr>
                <tr>
                  <td style="vertical-align: middle; text-align: center;">Perdarahan</td>
                  <td style="vertical-align: middle; text-align: center;"><br>Hipertensi<br>Dalam<br>Kehamilan<br></td>
                  <td style="vertical-align: middle; text-align: center;">Infeksi</td>
                  <td style="vertical-align: middle; text-align: center;"><br>Gangguan<br>Sistem<br>Peredaran<br>Darah<br></td>
                  <td style="vertical-align: middle; text-align: center;"><br>Gangguan<br>Metabolik<br></td>
                  <td style="vertical-align: middle; text-align: center;">Lain-Lain</td>
                </tr>                                   
              </thead>
              <tbody>
                <tr v-bind:key="item._id" v-for="(item, index) in listDesa">
                  ...
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PENYEBAB_KEMATIAN_IBU_PENDARAHAN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PENYEBAB_KEMATIAN_IBU_HIPERTENSI_DALAM_KEHAMILAN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PENYEBAB_KEMATIAN_IBU_INFEKSI }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PENYEBAB_KEMATIAN_IBU_GANGGUAN_SISTEM_PEREDARAN_DARAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PENYEBAB_KEMATIAN_IBU_GANGGUAN_METABOLIK }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].PENYEBAB_KEMATIAN_IBU_LAIN_LAIN }}</td>
                </tr> 
                <tr>
