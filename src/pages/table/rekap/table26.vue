        ...
        <div class="box">
          <div class="box-header with-border"> 
            <div class="alert alert-info alert-dismissible">
              ...
              <h4>Tabel 26 - PERSENTASE CAKUPAN IMUNISASI Td PADA WANITA USIA SUBUR (WUS) HAMIL DAN TIDAK HAMIL</h4>
              <div class="row">
                <div class="col-md-6">
          ...
          <!-- Pilih Range Rekap -->
          <PilihRangeRekapPus linkPage="table26" @dataRekap="getRekapBtn" />         
          <!-- Pilih Range Rekap -->           
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead id="dataTable" class="thead-dark">
                <tr>
                  ...
                  <th rowspan="3">Desa<br></th>
                  <th rowspan="3"><br>Jumlah WUS<br>Tidak Hamil<br>(15-39 Tahun)<br></th>
                  <th colspan="10">Imunisasi Td Pada WUS</th>
                </tr>
                <tr>
                  <td colspan="2">Td1</td>
                  <td colspan="2">Td2</td>
              ...
              <tbody>
                <tr v-bind:key="item._id" v-for="(item, index) in listDesa">
                  ...
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].JUMLAH_WUS_15_39_TAHUN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].IMUNISASI_TD_PADA_WUS_TD1_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].IMUNISASI_TD_PADA_WUS_TD2_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].IMUNISASI_TD_PADA_WUS_TD3_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].IMUNISASI_TD_PADA_WUS_TD4_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].IMUNISASI_TD_PADA_WUS_TD5_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].IMUNISASI_TD_PADA_WUS_TD1_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].IMUNISASI_TD_PADA_WUS_TD2_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].IMUNISASI_TD_PADA_WUS_TD3_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].IMUNISASI_TD_PADA_WUS_TD4_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].IMUNISASI_TD_PADA_WUS_TD5_PERSEN }}</td>
                </tr>
                <tr>
...
export default {
  ...
  methods: {
    ...
    initialData: function() {
      return {
        JUMLAH_WUS_15_39_TAHUN: 0,
        IMUNISASI_TD_PADA_WUS_TD1_JUMLAH: 0,
        IMUNISASI_TD_PADA_WUS_TD2_JUMLAH: 0,
        IMUNISASI_TD_PADA_WUS_TD3_JUMLAH: 0,
        IMUNISASI_TD_PADA_WUS_TD4_JUMLAH: 0,
        IMUNISASI_TD_PADA_WUS_TD5_JUMLAH: 0,
        IMUNISASI_TD_PADA_WUS_TD1_PERSEN: 0,
        IMUNISASI_TD_PADA_WUS_TD2_PERSEN: 0,
        IMUNISASI_TD_PADA_WUS_TD3_PERSEN: 0,
        IMUNISASI_TD_PADA_WUS_TD4_PERSEN: 0,
        IMUNISASI_TD_PADA_WUS_TD5_PERSEN: 0,      
      }
    },    
