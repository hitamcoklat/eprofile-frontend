        ...
        <div class="box">
          <div class="box-header with-border"> 
            ...
            <div class="col-md-6">
              ...
              <router-link to="/dataDasar/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-bordered">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th rowspan="3">No</th>
                  <th colspan="12" rowspan="2">RUMAH SAKIT</th>
                  <th colspan="2" rowspan="2">LUAS</th>
                  <th colspan="5" rowspan="2">SURAT IZIN</th>
                  <th colspan="2" rowspan="2">PENYELENGGARA</th>
                  <th colspan="2" rowspan="2">AKREDITAS</th>
                  <th colspan="5" rowspan="2">TEMPAT TIDUR <br>MENURUT KELAS<br></th>
                  <th colspan="19">KETENAGAAN RUMAH SAKIT</th>
                </tr>
                <tr>
                  <td colspan="14">DOKTER</td>
                  <td colspan="5">LAINNYA<br></td>
                </tr>
                <tr>
                  <td>Jenis RS</td>
                  <td>Kelas RS</td>
                  ...
                  <td>Bidan</td>
                  <td>Farmasi<br></td>
                  <td>Tenaga Kesehatan<br> Lainnya</td>
                  <td>Non-Kesehatan</td>
                </tr>                                   
              </thead>
              <tbody>                  
