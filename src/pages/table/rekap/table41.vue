    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <!-- Pilih Range Rekap -->
          <PilihRangeRekapPus linkPage="table41" @dataRekap="getRekapBtn" />         
          <!-- Pilih Range Rekap -->             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th style="vertical-align: middle; text-align: center;" colspan="3">Bayi 6-11 Bulan</th>
                  <th style="vertical-align: middle; text-align: center;" colspan="3">Anak Balita (12-59 Bulan)<br></th>
                  <th style="vertical-align: middle; text-align: center;" colspan="3">Balita (6-59 Bulan)</th>
                </tr>
                <tr>
                  <td style="vertical-align: middle; text-align: center;" rowspan="2">Jumlah</td>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">Mendapat VIT A</td>
                  <td style="vertical-align: middle; text-align: center;" rowspan="2">Jumlah</td>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">Mendapat VIT A</td>
                  <td style="vertical-align: middle; text-align: center;" rowspan="2">Jumlah</td>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">Mendapat VIT A</td>
              ...
              <tbody>                  
                <tr v-bind:key="item._id" v-for="(item, index) in listDesa">
                  ...
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_6_11_BULAN_JUMLAH_BAYI }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_6_11_BULAN_MENDAPAT_VIT_A_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_6_11_BULAN_MENDAPAT_VIT_A_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].ANAK_BALITA_12_59_BULAN_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].ANAK_BALITA_12_59_BULAN_MENDAPAT_VIT_A_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].ANAK_BALITA_12_59_BULAN_MENDAPAT_VIT_A_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BALITA_6_59_BULAN_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BALITA_6_59_BULAN_MENDAPAT_VIT_A_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BALITA_6_59_BULAN_MENDAPAT_VIT_A_PERSEN }}</td>
                </tr>  
                <tr>
