        ...
        <div class="box">
          <div class="box-header with-border"> 
            <div class="alert alert-info alert-dismissible">
              ...
              <h4>Tabel Tambahan - Persentase Rumah Tangga Berperilaku Hidup Bersih dan Sehat (Ber-PHBS) Menurut Kabupaten/Kota</h4>
              <div class="row">
                <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <router-link to="/phbs/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-bordered">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th colspan="5">Rumah Tangga</th>
                </tr>
                <tr>
                  <td>Jumlah</td>
                  <td>Jumlah di<br>Pantau<br></td>
                  <td>Persen<br>Pantau<br></td>
                  <td>Jumlah<br>Ber-PHBS<br></td>
                  <td>Persen<br>Ber-PHBS<br></td>
                </tr>                
              </thead>                                                  
              <tbody>                  
                <tr>
