        ...
        <div class="box">
          <div class="box-header with-border"> 
            ...
            <div class="col-md-2">
              <div class="form-group">
                <select class="form-control">
                  <option selected="">Pilih Kelompok Umur (TAHUN)</option>
                  <option>All</option>
                  <option>0-4</option>
                  <option>5-9</option>
                  <option>10-14</option>
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table2/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th colspan="3">JUMLAH PENDUDUK<br></th>
          ...
          <div class="box-footer clearfix">
            <button type="button" class="btn bg-navy btn-md"><i class="fa fa-fw fa-file-excel-o"></i>Export to Excel</button>
            <router-link to="/table3/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
