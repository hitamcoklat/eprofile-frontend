        ...
        <div class="box">
          <div class="box-header with-border"> 
            <div class="alert alert-info alert-dismissible">
              ...
              <h4>Tabel Tambahan - Jumlah Desa/Kelurahan Siaga Menurut Kabupaten/Kota</h4>
              <div class="row">
                <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <router-link to="/desaSiaga/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-bordered">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th rowspan="2">Jumlah<br>Desa/Kelurahan<br></th>
                  <th colspan="6">Desa/Kelurahan Siaga</th>
                </tr>
                <tr>
                  <td>Pratama</td>
                  <td>Madya</td>
