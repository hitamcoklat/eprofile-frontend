        ...
        <div class="box">
          <div class="box-header with-border"> 
            <div class="alert alert-info alert-dismissible">
              ...
              <h4>Tabel 55 - JUMLAH KASUS DAN KEMATIAN AKIBAT AIDS MENURUT JENIS KELAMIN DAN KELOMPOK UMUR </h4>
              <div class="row">
                <div class="col-md-6">
            ...
            <div class="col-md-2">
              <div class="form-group">
                <select class="form-control">
                  <option selected="">Pilih Kelompok Umum</option>
                  <option>< 1 Tahun</option>
                  <option>1 - 4 Tahun</option>
                  <option>5 - 14 Tahun</option>
                  <option>15 - 19 Tahun</option>
                  <option>20 - 29 Tahun</option>
                  <option>30 - 39 Tahun</option>                  
                  <option>40 - 49 Tahun</option>                  
                  <option>50 - 59 Tahun</option>                  
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table55/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th colspan="4">KASUS BARU AIDS</th>
                  <th colspan="4">KASUS KUMULATIF AIDS</th>
                  <th colspan="3">JUMLAH KEMATIAN AKIBAT AIDS</th>
                </tr>
                <tr>
                  <td>L</td>
                  <td>P</td>
