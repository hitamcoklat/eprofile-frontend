    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <!-- Pilih Range Rekap -->
          <PilihRangeRekapPus linkPage="table59" @dataRekap="getRekapBtn" />         
          <!-- Pilih Range Rekap -->              
          </div>
          <!-- /.box-header -->
            ...
            <table id="dataTable" class="table table-hover table-bordered">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th style="vertical-align: middle; text-align: center;" colspan="9">KASUS TERDAFTAR </th>
                </tr>
                <tr>
                  <td style="vertical-align: middle; text-align: center;" colspan="3">PAUSI BASILER/KUSTA KERING</td>
                  <td style="vertical-align: middle; text-align: center;" colspan="3">MULTI BASILER/KUSTA BASAH</td>
              ...
              <tbody>                  
                <tr v-bind:key="item._id" v-for="(item, index) in listDesa">
                  ...
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].KASUS_TERDAFTAR_PAUSI_BASILER_KUSTA_KERING_L }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].KASUS_TERDAFTAR_PAUSI_BASILER_KUSTA_KERING_P }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].KASUS_TERDAFTAR_PAUSI_BASILER_KUSTA_KERING_L_P }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].KASUS_TERDAFTAR_MULTI_BASILER_KUSTA_BASILER_L }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].KASUS_TERDAFTAR_MULTI_BASILER_KUSTA_BASILER_P }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].KASUS_TERDAFTAR_MULTI_BASILER_KUSTA_BASILER_L_P }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].KASUS_TERDAFTAR_JUMLAH_L }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].KASUS_TERDAFTAR_JUMLAH_P }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].KASUS_TERDAFTAR_JUMLAH_L_P }}</td>
                </tr>
                <tr>
