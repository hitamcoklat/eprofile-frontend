    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box">
          ...
          <!-- Pilih Range Rekap -->
          <PilihRangeRekapPus linkPage="table35" @dataRekap="getRekapBtn" />         
          <!-- Pilih Range Rekap -->            
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th style="vertical-align: middle; text-align: center;" colspan="4">Bayi Baru Lahir</th>
                  <th style="vertical-align: middle; text-align: center;" colspan="3">Bayi Usia &lt; 6 Bulan</th>
                </tr>
                <tr>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">Jumlah</td>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">Mendapat IMD</td>
                  <td style="vertical-align: middle; text-align: center;" rowspan="2">Jumlah</td>
                  <td style="vertical-align: middle; text-align: center;" colspan="2">Diberi ASI Ekslusif</td>
                </tr>
                <tr>
              ...
              <tbody> 
                <tr v-bind:key="item._id" v-for="(item, index) in listDesa">
                  ...
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_BARU_LAHIR_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_BARU_LAHIR_MENDAPAT_IMD_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_BARU_LAHIR_MENDAPAT_IMD_PERSEN }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_USIA_KURANG_DARI_6_BULAN_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_USIA_KURANG_DARI_6_BULAN_DIBERI_ASI_EKSLUSIF_JUMLAH }}</td>
                  <td style="vertical-align: middle; text-align: center;">{{ detailDesa[index].BAYI_USIA_KURANG_DARI_6_BULAN_DIBERI_ASI_EKSLUSIF_PERSEN }}</td>
                </tr> 
                <tr>
