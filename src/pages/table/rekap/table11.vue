        ...
        <div class="box">
          <div class="box-header with-border"> 
            <div class="alert alert-info alert-dismissible">
              ...
              <h4>Tabel 11 - JUMLAH TENAGA MEDIS DI FASILITAS KESEHATAN</h4>
              <div class="row">
                <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table11/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-bordered">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th colspan="3">dr. Spesialis<br></th>
                  <th colspan="3">dr. Umum</th>
                  <th colspan="3">Total</th>
                  <th colspan="3">dr. Gigi</th>
                  <th colspan="3">dr. Gigi Spesialis</th>
                  <th colspan="3">Total</th>
                </tr>
                <tr>
                  <td>L</td>
