        ...
        <div class="box">
          <div class="box-header with-border"> 
            <div class="alert alert-info alert-dismissible">
              ...
              <h4>Tabel 60 - PENDERITA KUSTA SELESAI BEROBAT (RELEASE FROM TREATMENT/RFT) MENURUT JENIS KELAMIN, KECAMATAN DAN PUSKESMAS </h4>
              <div class="row">
                <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table60/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-bordered">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th colspan="9">KUSTA (PB) Tahun </th>
                  <th colspan="9">KUSTA (MB) Tahun </th>
                </tr>
                <tr>
                  <td colspan="3" rowspan="2">PENDERITA PB</td>
                  <td colspan="6">RFT PB</td>
                  <td colspan="3" rowspan="2">PENDERITA MB</td>
                  <td colspan="6">RFT PB</td>
                </tr>
                <tr>
                  <td colspan="2">L</td>
              ...
              <tfoot>
                <tr>
                  ...
                  <th rowspan="4">KECAMATAN</th>
                  <th rowspan="4">PUSKESMAS</th>
                  <th colspan="9">KUSTA (PB) </th>
                  <th colspan="9">KUSTA (MB)</th>
                </tr>
                <tr>
                  <td colspan="3" rowspan="2">PENDERITA PB</td>
                  <td colspan="6">RFT PB</td>
