        ...
        <div class="box">
          <div class="box-header with-border"> 
            <div class="alert alert-info alert-dismissible">
              ...
              <h4>Tabel 12 - JUMLAH TENAGA KEPERAWATAN DAN KEBIDANAN DI FASILITAS KESEHATAN</h4>
              <div class="row">
                <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table12/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th colspan="3" rowspan="2">Bidan</th>
                </tr>
                <tr>
                  <td>L</td>
                  <td>P</td>
