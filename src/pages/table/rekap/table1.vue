        ...
        <div class="box">
          <div class="box-header with-border"> 
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table1/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th rowspan="2">Luas<br>Wilayah<br></th>
                  <th colspan="3"><center>Jumlah</center></th>
                  <th rowspan="2">Jumlah <br>Penduduk</th>
                  <th rowspan="2">Jumlah<br>Rumah <br>Tangga</th>
                  <th rowspan="2">Rata-Rata<br>Jiwa/Rumah<br>Tangga<br></th>
                  <th rowspan="2">Kepadatan<br>Pendudukan</th>
                </tr>
                <tr>
