        ...
        <div class="box">
          <div class="box-header with-border"> 
            ...
            <div class="col-md-6">
              ...
              <router-link to="/table68/input"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-plus-circle"></i></i>Tambah Data </a></router-link>
            </div>             
          </div>
          <!-- /.box-header -->
            ...
            <table class="table table-striped">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th colspan="3" rowspan="2">JUMLAH ESTIMASI PENDERITA HIPERTENSI BERUSIA ≥ 15 TAHUN</th>
