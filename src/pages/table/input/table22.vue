      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <div class="alert alert-info alert-dismissible">
            ...
            <h4>Tabel 22 - JUMLAH KEMATIAN IBU MENURUT PENYEBAB</h4>
        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Penyebab Kematian Ibu Perdarahan </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" v-model="PENYEBAB_KEMATIAN_IBU_PENDARAHAN" id="" name="penyebab_kematian_ibu_perdarahan" placeholder="">
                </div>
              </div>                  
            </div> 
            <div class="col-md-6"> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Penyebab Kematian Ibu Hipertensi dalam Kehamilan </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PENYEBAB_KEMATIAN_IBU_HIPERTENSI_DALAM_KEHAMILAN" name="penyebab_kematian_ibu_hipertensi_dalam_kehamilan" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Penyebab Kematian Ibu Infeksi </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PENYEBAB_KEMATIAN_IBU_INFEKSI" name="penyebab_kematian_ibu_infeksi" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Penyebab Kematian Ibu Gangguan Sistem Peredaran Darah </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PENYEBAB_KEMATIAN_IBU_GANGGUAN_SISTEM_PEREDARAN_DARAH" name="penyebab_kematian_ibu_gangguan_sistem_peredaran_darah" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Penyebab Kematian Ibu Gangguan Metabolik </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PENYEBAB_KEMATIAN_IBU_GANGGUAN_METABOLIK" name="penyebab_kematian_ibu_gangguan_metabolik" placeholder="">
                </div>
              </div>                  
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Penyebab Kematian Ibu Lain-Lain </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PENYEBAB_KEMATIAN_IBU_LAIN_LAIN" name="jumlah_kematian_ibu_bersalin_kurang_20_tahun" placeholder="">
                </div>
              </div>                                    
            </div>                
          </div>
          ...
          <div class="box-footer">
            ...
            <router-link to="/table22"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
    <!-- /.modal -->
...
export default {
  ...
  data() {
    return {
      ...
      ID_DESA: '',
      listDesa: [],
      PENYEBAB_KEMATIAN_IBU_PENDARAHAN: 0,
      PENYEBAB_KEMATIAN_IBU_HIPERTENSI_DALAM_KEHAMILAN: 0,
      PENYEBAB_KEMATIAN_IBU_INFEKSI: 0,
      PENYEBAB_KEMATIAN_IBU_GANGGUAN_SISTEM_PEREDARAN_DARAH: 0,
      PENYEBAB_KEMATIAN_IBU_GANGGUAN_METABOLIK: 0,
      PENYEBAB_KEMATIAN_IBU_LAIN_LAIN: 0,
      isUpdate: false  
    }
  },
  methods: {
    ...
    checkData: function(data) {
      ...
      Object.keys(myArray).forEach(element => {
        ...
        this.$http.get(this.$urlNode + '/table/getField?var=' + element + '&thn='+this.PILIH_TAHUN+'&bln=' + this.PILIH_BULAN + '&username=' + this.USERNAME + '&id_desa=' + this.ID_DESA)
          ...
          .then(() => {
            if(this.PENYEBAB_KEMATIAN_IBU_GANGGUAN_SISTEM_PEREDARAN_DARAH != 0) {
              this.isUpdate = true;
            }                
          })  
          .catch(function (error) {
