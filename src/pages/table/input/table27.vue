      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <div class="alert alert-info alert-dismissible">
            ...
            <h4>Tabel 27 - JUMLAH IBU HAMIL YANG MENDAPATKAN TABLET TAMBAH DARAH (TTD)</h4>
        ...
        <form class="form-horizontal">
          <div class="box-body">
            ...
            <div class="col-md-6">                    
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="IBU_HAMIL_JUMLAH" v-on:blur="ttd90TabletPersen()" name="ibu_hamil_jumlah" disabled placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> TTD(90 Tablet) Jumlah </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="ttd90TabletPersen()" v-model="TTD_90_TABLET_JUMLAH" name="ttd_90_tablet_jumlah" placeholder="">
                </div>
              </div><div class="form-group">
                <label for="" class="col-sm-6 control-label"> TTD(90 Tablet) Persen</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="TTD_90_TABLET_PERSEN" name="ttd_90_tablet_persen" placeholder="">
                </div>
              </div>                                                                      
            </div>                 
          </div>
          ...
          <div class="box-footer">
            ...
            <router-link to="/table27"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
    <!-- /.modal -->
...
export default {
  ...
  data() {
    return {
      ...
      listDesa: [],
      IBU_HAMIL_JUMLAH: 0,
      TTD_90_TABLET_JUMLAH: 0,
      TTD_90_TABLET_PERSEN: 0,
      isUpdate: false  
    }
  },
  methods: {
    ...
    ttd90TabletPersen: function() {
      this.TTD_90_TABLET_PERSEN =
        parseInt((this.TTD_90_TABLET_JUMLAH == '') ? 0 : this.TTD_90_TABLET_JUMLAH) / 
    ...
    checkData: function(data) {
      ...
      Object.keys(myArray).forEach(element => {
        ...
        this.$http.get(this.$urlNode + '/table/getField?var=' + element + '&thn='+this.PILIH_TAHUN+'&bln=' + this.PILIH_BULAN + '&username=' + this.USERNAME + '&id_desa=' + this.ID_DESA)
          ...
          .then(() => {
            if(this.TTD_90_TABLET_JUMLAH != 0) {
              this.isUpdate = true;
            }                
          })  
          .catch(function (error) {
