        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Kelahiran Laki-Laki Hidup </label>
                <div class="col-sm-4">
                  <input type="text" v-model="JUMLAH_KELAHIRAN_LAKI_LAKI_HIDUP" class="form-control" id="" name="jumlah_kelahiran_laki_laki_hidup" v-on:blur="jmlKelahiranLakiHidupMati()" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Kelahiran Laki-Laki Mati </label>
                <div class="col-sm-4">
                  <input type="text" v-model="JUMLAH_KELAHIRAN_LAKI_LAKI_MATI" class="form-control" id="" name="jumlah_kelahiran_laki_laki_mati" v-on:blur="jmlKelahiranLakiHidupMati()" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Kelahiran Laki-Laki Hidup+Mati </label>
                <div class="col-sm-4">
                  <input type="text" disabled v-model="JUMLAH_KELAHIRAN_LAKI_LAKI_HIDUP_MATI" class="form-control" id="" name="jumlah_kelahiran_laki_laki_hidup_mati" placeholder="">
                </div>
              </div>
            </div> 
            <div class="col-md-6"> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Kelahiran Perempuan Hidup </label>
                <div class="col-sm-4">
                  <input type="text" v-model="JUMLAH_KELAHIRAN_PEREMPUAN_HIDUP" class="form-control" id="" name="jumlah_kelahiran_perempuan_hidup" v-on:blur="jmlKelahiranPerempuanHidupMati()" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Kelahiran Perempuan Mati </label>
                <div class="col-sm-4">
                  <input type="text" v-model="JUMLAH_KELAHIRAN_PEREMPUAN_MATI" class="form-control" id="" name="jumlah_kelahiran_perempuan_mati" v-on:blur="jmlKelahiranPerempuanHidupMati()" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Kelahiran Perempuan Hidup+Mati </label>
                <div class="col-sm-4">
                  <input type="text" disabled v-model="JUMLAH_KELAHIRAN_PEREMPUAN_HIDUP_MATI" class="form-control" id="" name="jumlah_kelahiran_perempuan_hidup_mati" placeholder="">
                </div>
              </div>                                                                       
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Kelahiran Laki+Perempuan Hidup </label>
                <div class="col-sm-4">
                  <input type="text" disabled v-model="JUMLAH_KELAHIRAN_LAKI_PEREMPUAN_HIDUP" class="form-control" id="" name="jumlah_kelahiran_laki_perempuan_hidup" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Kelahiran Laki+Perempuan Mati </label>
                <div class="col-sm-4">
                  <input type="text" v-model="JUMLAH_KELAHIRAN_LAKI_PEREMPUAN_MATI" class="form-control" id="" name="jumlah_kelahiran_laki_perempuan_mati" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Kelahiran Laki+Perempuan Hidup+Mati </label>
                <div class="col-sm-4">
                  <input type="text" disabled v-model="JUMLAH_KELAHIRAN_LAKI_PEREMPUAN_HIDUP_MATI" class="form-control" id="" name="jumlah_kelahiran_laki_perempuan_hidup_mati" placeholder="">
                </div>
              </div>                                   
            </div>                
          </div>
          ...
          <div class="box-footer">
            ...
            <router-link to="/table20"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
    <!-- /.modal -->
...
export default {
  ...
  methods: {
    ...
    jmlKelahiranLakiHidupMati: function() {
      this.JUMLAH_KELAHIRAN_LAKI_LAKI_HIDUP_MATI =
        parseInt((this.JUMLAH_KELAHIRAN_LAKI_LAKI_HIDUP == '') ? 0 : this.JUMLAH_KELAHIRAN_LAKI_LAKI_HIDUP) + 
        parseInt((this.JUMLAH_KELAHIRAN_LAKI_LAKI_MATI == '') ? 0 : this.JUMLAH_KELAHIRAN_LAKI_LAKI_MATI)
    },
    jmlKelahiranPerempuanHidupMati: function() {
      this.JUMLAH_KELAHIRAN_PEREMPUAN_HIDUP_MATI =
        parseInt((this.JUMLAH_KELAHIRAN_PEREMPUAN_HIDUP == '') ? 0 : this.JUMLAH_KELAHIRAN_PEREMPUAN_HIDUP) + 
        parseInt((this.JUMLAH_KELAHIRAN_PEREMPUAN_MATI == '') ? 0 : this.JUMLAH_KELAHIRAN_PEREMPUAN_MATI)
      
      this.JUMLAH_KELAHIRAN_LAKI_PEREMPUAN_HIDUP =
        parseInt((this.JUMLAH_KELAHIRAN_LAKI_LAKI_HIDUP == '') ? 0 : this.JUMLAH_KELAHIRAN_LAKI_LAKI_HIDUP) + 
        parseInt((this.JUMLAH_KELAHIRAN_PEREMPUAN_HIDUP == '') ? 0 : this.JUMLAH_KELAHIRAN_PEREMPUAN_HIDUP)

      this.JUMLAH_KELAHIRAN_LAKI_PEREMPUAN_MATI =
        parseInt((this.JUMLAH_KELAHIRAN_LAKI_LAKI_MATI == '') ? 0 : this.JUMLAH_KELAHIRAN_LAKI_LAKI_MATI) + 
        parseInt((this.JUMLAH_KELAHIRAN_PEREMPUAN_MATI == '') ? 0 : this.JUMLAH_KELAHIRAN_PEREMPUAN_MATI)
      
      this.JUMLAH_KELAHIRAN_LAKI_PEREMPUAN_HIDUP_MATI =
        parseInt((this.JUMLAH_KELAHIRAN_LAKI_PEREMPUAN_HIDUP == '') ? 0 : this.JUMLAH_KELAHIRAN_LAKI_PEREMPUAN_HIDUP) + 
        parseInt((this.JUMLAH_KELAHIRAN_LAKI_PEREMPUAN_MATI == '') ? 0 : this.JUMLAH_KELAHIRAN_LAKI_PEREMPUAN_MATI)
