      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <div class="alert alert-info alert-dismissible">
            ...
            <h4>Tabel 63 - KEJADIAN LUAR BIASA (KLB) DI DESA/KELURAHAN YANG DITANGANI < 24 JAM </h4>
        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> KLB Di Desa/Kelurahan Jumlah </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="JUMLAH_KLB_DI_DESA_KELURAHAN" name="klb_didesa_kelurahan_jumlah" placeholder="" v-on:blur="persenKLB()">
                </div>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> KLB Di Desa/Kelurahan Ditangani < 24 Jam </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="KLB_DESA_KELURAHAN_DITANGANI_KURANG_24_JAM" name="klb_didesa_kelurahan_ditangani_kurang_dari_24_jam" placeholder="" v-on:blur="persenKLB()">
                </div>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> KLB Di Desa/Kelurahan Persen </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PERSEN_KLN_DESA_KELURAHAN" name="klb_didesa_kelurahan_persen" placeholder="">
                </div>
              </div>
          ...
          <div class="box-footer">
            ...
            <router-link to="/table63"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
      <!-- /.modal -->
...
export default {
  ...
  data() {
    return {
      ...
      ID_DESA: '',
      listDesa: [],
      JUMLAH_KLB_DI_DESA_KELURAHAN: 0,
      KLB_DESA_KELURAHAN_DITANGANI_KURANG_24_JAM: 0,
      PERSEN_KLN_DESA_KELURAHAN: 0,
      isUpdate: false
    }
  },  
  name: 'Table63',
  methods: {
    ...
    persenKLB: function () {
      this.PERSEN_KLN_DESA_KELURAHAN = 
        parseInt((this.KLB_DESA_KELURAHAN_DITANGANI_KURANG_24_JAM == '') ? 0 : this.KLB_DESA_KELURAHAN_DITANGANI_KURANG_24_JAM) /
        parseInt((this.JUMLAH_KLB_DI_DESA_KELURAHAN == '') ? 0 : this.JUMLAH_KLB_DI_DESA_KELURAHAN)*100;
    },      
    ...
    checkData: function(data) {
        ...
        Object.keys(myArray).forEach(element => {
          ...
          this.$http.get(this.$urlNode + '/table/getField?var=' + element + '&thn='+this.PILIH_TAHUN+'&bln=' + this.PILIH_BULAN + '&username=' + this.USERNAME + '&id_desa=' + this.ID_DESA)
            ...
            .then(() => {
              if(this.KLB_DESA_KELURAHAN_DITANGANI_KURANG_24_JAM != 0) {
                this.isUpdate = true;
              }                
            })  
            .catch(function (error) {
