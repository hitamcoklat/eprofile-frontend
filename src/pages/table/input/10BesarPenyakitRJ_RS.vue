      ...
      <div class="box box-info">
        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input v-model="ICD_RAWAT_JALAN" type="text" class="form-control" id="" name="icd_ri_rs" placeholder="">
                </div>
              </div>  
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Nama Penyakit</label>
                <div class="col-sm-4">
                  <input v-model="NAMA_PENYAKIT_RAWAT_JALAN" type="text" class="form-control" id="" name="nama_penyakit_ri_rs" placeholder="">
                </div>
              </div>                                                          
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Kasus Baru</label>
                <div class="col-sm-4">
                  <input v-model="JUMLAH_KASUS_BARU_RAWAT_JALAN" type="text" class="form-control" id="" name="jumlah_kasus_baru_ri_rs" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Kunjungan</label>
                <div class="col-sm-4">
                  <input v-model="JUMLAH_KUNJUNGAN_RAWAT_JALAN" type="text" class="form-control" id="" name="jumlah_kunjungan_ri_rs" placeholder="">
                </div>
              </div>              
            </div>                                          
          </div>
          ...
          <div class="box-footer">
            ...
            <button type="button" @click="proses()" class="btn btn-primary" data-toggle="modal" data-target="#modal-primary"><i class="fa fa-fw fa-recycle"></i>
            Proses
            </button>                
            <router-link to="/10BesarPenyakitRJ_RS"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
      <!-- /.modal -->
