      ...
      <div class="box box-info">
        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="col-md-12">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="" class="col-sm-6 control-label">Rumah Sakit</label>
                  <div class="col-sm-4">
                    <select v-model="JENIS_RS" class="form-control">
                      <option selected="selected">Pilih </option>
                      <option value="rsu">Rumah Sakit Umum</option>
                      <option value="rsk">Rumah Sakit Khusus</option>                    
                    </select>
                  </div>
                </div>                  
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input v-model="JUMLAH_GADAR" type="text" class="form-control" id="" name="jumlah_gadar" placeholder="">
                  </div>
                </div>                                                        
                <div class="form-group">
                  <label for="" class="col-sm-6 control-label">Mempunyai Kemampuan Pelayanan Gadar Level 1 Jumlah</label>
                  <div class="col-sm-4">
                    <input v-model="MEMPUNYAI_KEMAMPUAN_YAN_GADAR_LEVEL1_JUMLAH" type="text" class="form-control" id="" name="mempunyai_kemampuan_pelayanan_gadar_lev_1_jumlah" placeholder="">
                  </div>
                </div>
                <div class="form-group">
                  <label for="" class="col-sm-6 control-label">Mempunyai Kemampuan Pelayanan Gadar Level 1 Persen</label>
                  <div class="col-sm-4">
                    <input v-model="MEMPUNYAI_KEMAMPUAN_YAN_GADAR_LEVEL1_PERSEN" type="text" class="form-control" id="" name="mempunyai_kemampuan_pelayanan_gadar_lev_1_persen" placeholder="">
                  </div>    
              <!-- /.tab-content -->
                </div>                                                        
              </div>
          ...
          <div class="box-footer">
            ...
            <button type="button" class="btn btn-primary" v-on:click="proses"><i class="fa fa-fw fa-recycle"></i>
            Proses
            </button>                
            <router-link to="/table6"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
      <!-- /.modal -->
