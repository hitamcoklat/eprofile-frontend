        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <span class="badge bg-green">Pelayanan Kesehatan Gigi dan Mulut</span>
              </div>                                                     
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Tumpatan Gigi Tetap </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="rasioTumpatanPencabutan()" v-model="PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_TUMPATAN_GIGI_TETAP" name="pelayanan_kesehatan_gigi_dan_mulut_tumpatan_gigi_tetap" placeholder="">
                </div>
              </div>
            </div>
            <div class="col-md-6">                     
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Pencabutan Gigi Tetap</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="rasioTumpatanPencabutan()" v-model="PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_PENCABUTAN_GIGI_TETAP" name="pelayanan_kesehatan_gigi_dan_mulut_pencabutan_gigi_tetap" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Rasio Tumpatan/Pencabutan </label>
                <div class="col-sm-4">
                  <input disabled type="text" class="form-control" id="" v-model="PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_RASIO_TUMPATAN_PENCABUTAN" name="pelayanan_kesehatan_gigi_dan_mulut_rasio_tumpatan_pencabutan" placeholder="">
                </div>
              </div>                                    
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Jumlah Kasus Gigi </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="persenKasusDirujuk()" v-model="PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_JUMLAH_KASUS_GIGI" name="pelayanan_kesehatan_gigi_dan_mulut_jumlah_kasus_gigi" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Jumlah Kasus Dirujuk </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="persenKasusDirujuk()" v-model="PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_JUMLAH_KASUS_DIRUJUK" name="pelayanan_kesehatan_gigi_dan_mulut_jumlah_kasus_dirujuk" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Persen Kasus Dirujuk </label>
                <div class="col-sm-4">
                  <input disabled type="text" class="form-control" id="" v-model="PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_PERSEN_KASUS_DIRUJUK" name="pelayanan_kesehatan_gigi_dan_mulut_persen_kasus_dirujuk" placeholder="">
                </div>
              </div>                             
            </div>                              
          </div>
          ...
          <div class="box-footer">
            ...
            <router-link to="/table46"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
      <!-- /.modal -->
...
export default {
  ...
  methods: {
    ...
    rasioTumpatanPencabutan: function() {
      this.PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_RASIO_TUMPATAN_PENCABUTAN = 
         parseInt((this.PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_TUMPATAN_GIGI_TETAP == '') ? 0 : this.PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_TUMPATAN_GIGI_TETAP) /
         parseInt((this.PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_PENCABUTAN_GIGI_TETAP == '') ? 0 : this.PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_PENCABUTAN_GIGI_TETAP) ;
    },  
    persenKasusDirujuk: function() {
      this.PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_PERSEN_KASUS_DIRUJUK = 
        parseInt((this.PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_JUMLAH_KASUS_DIRUJUK == '') ? 0 : this.PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_JUMLAH_KASUS_DIRUJUK) /
        parseInt((this.PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_JUMLAH_KASUS_GIGI == '') ? 0 : this.PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_JUMLAH_KASUS_GIGI) ;
    },      
    ...
    checkData: function(data) {
      ...
      Object.keys(myArray).forEach(element => {
        ...
        this.$http.get(this.$urlNode + '/table/getField?var=' + element + '&thn='+this.PILIH_TAHUN+'&bln=' + this.PILIH_BULAN + '&username=' + this.USERNAME + '&id_desa=' + this.ID_DESA)
          ...
          .then(() => {
            if(this.PELAYANAN_KESEHATAN_GIGI_DAN_MULUT_PENCABUTAN_GIGI_TETAP != 0) {
              this.isUpdate = true;
            }                
          })  
          .catch(function (error) {
