        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Jumlah KK </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="JUMLAH_KK" name="jumlah_kk" placeholder="">
                </div>
              </div> 
              <div class="form-group">
                <span class="badge bg-green">a. Sharing / Komunal </span>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Jumlah Sarana </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="SHARING_KOMUNAL_JUMLAH_SARANA" name="sharing_komunal_jumlah_sarana" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Jumlah KK Pengguna </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="jmlJambanSehat()" v-model="SHARING_KOMUNAL_JUMLAH_KK_PENGGUNA" name="sharing_komunal_jumlah_kk_pengguna" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <span class="badge bg-green">b. Jamban Sehat Semi Permanen (JSSP) </span>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Jumlah Sarana </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="JAMBAN_SEHAT_SEMI_PERMANEN_JSSP_JUMLAH_SARANA" name="jumlah_sehat_semi_permanen_jssp_jumlah_sarana" placeholder="">
                </div>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Jumlah KK Penggguna </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="jmlJambanSehat()" v-model="JAMBAN_SEHAT_SEMI_PERMANEN_JSSP_JUMLAH_KK_PENGGUNA" name="jumlah_sehat_semi_permanen_jssp_jumlah_kk_pengguna" placeholder="">
                </div>
              </div>         
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <span class="badge bg-green">c. Jamban Sehat Permanen (JSP) </span>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Jumlah Sarana </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="JAMBAN_SEHAT_PERMANEN_JSP_JUMLAH_SARANA" name="jumlah_sehat_permanen_jsp_jumlah_sarana" placeholder="">
                </div>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Jumlah KK Pengguna  </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="jmlJambanSehat()" v-model="JAMBAN_SEHAT_PERMANEN_JSP_JUMLAH_KK_PENGGUNA" name="jumlah_sehat_permanen_jumlah_kk_pengguna" placeholder="">
                </div>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Keluarga Dengan Akses Terhadap Fasilitas Sanitasi Yang Layak (Jamban Sehat) Jumlah </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="persenJambanSehat()" v-model="KELUARGA_DENGAN_AKSES_TERHADAP_FASILITAS_SANITASI_YANG_LAYAK_JUMLAH" name="keluarga_dengan_akses_terhadap_fasilitas_sanitasi_yang_layak_jumlah" placeholder="">
                </div>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Keluarga Dengan Akses Terhadap Fasilitas Sanitasi Yang Layak (Jamban Sehat) Persen </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="KELUARGA_DENGAN_AKSES_TERHADAP_FASILITAS_SANITASI_YANG_LAYAK_PERSEN" name="keluarga_dengan_akses_terhadap_fasilitas_sanitasi_yang_layak_persen" placeholder="">
                </div>
              </div> 
            </div>                                          
          </div>
          ...
          <div class="box-footer">
            ...
            <router-link to="/table73"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
      <!-- /.modal -->
...
export default {
  ...
  methods: {
    ...
    jmlJambanSehat: function() {      
      this.KELUARGA_DENGAN_AKSES_TERHADAP_FASILITAS_SANITASI_YANG_LAYAK_JUMLAH = 
        parseInt((this.SHARING_KOMUNAL_JUMLAH_KK_PENGGUNA == '') ? 0 : this.SHARING_KOMUNAL_JUMLAH_KK_PENGGUNA) +
        parseInt((this.JAMBAN_SEHAT_SEMI_PERMANEN_JSSP_JUMLAH_KK_PENGGUNA == '') ? 0 : this.JAMBAN_SEHAT_SEMI_PERMANEN_JSSP_JUMLAH_KK_PENGGUNA)+    
        parseInt((this.JAMBAN_SEHAT_PERMANEN_JSP_JUMLAH_KK_PENGGUNA == '') ? 0 : this.JAMBAN_SEHAT_PERMANEN_JSP_JUMLAH_KK_PENGGUNA);    
    },
    persenJambanSehat: function() {      
      this.KELUARGA_DENGAN_AKSES_TERHADAP_FASILITAS_SANITASI_YANG_LAYAK_PERSEN = 
        parseInt((this.KELUARGA_DENGAN_AKSES_TERHADAP_FASILITAS_SANITASI_YANG_LAYAK_JUMLAH == '') ? 0 : this.KELUARGA_DENGAN_AKSES_TERHADAP_FASILITAS_SANITASI_YANG_LAYAK_JUMLAH) /
        parseInt((this.JUMLAH_KK == '') ? 0 : this.JUMLAH_KK) * 100;    
    },    
    ...
    checkData: function(data) {
      ...
      Object.keys(myArray).forEach(element => {
        ...
        this.$http.get(this.$urlNode + '/table/getField?var=' + element + '&thn='+this.PILIH_TAHUN+'&bln=' + this.PILIH_BULAN + '&username=' + this.USERNAME + '&id_desa=' + this.ID_DESA)
          ...
          .then(() => {
            if(this.JAMBAN_SEHAT_SEMI_PERMANEN_JSSP_JUMLAH_KK_PENGGUNA != 0) {
              this.isUpdate = true;
            }                
          })  
          .catch(function (error) {
