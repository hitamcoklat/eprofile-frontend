      ...
      <div class="box box-info">
        ...
        <form class="form-horizontal">
          <div class="box-body">
            ...
            <div class="col-md-6">    
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="persenUCI()" v-model="JUMLAH_DESA_KELUARAHAN" name="jumlah_desa_kelurahan" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Desa/Kelurahan UCI</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="persenUCI()" v-model="DESA_KELURAHAN_UCI" name="desa_kelurahan_uci" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Persen Desa/Kelurahan UCI </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="DESA_KELURAHAN_PERSEN" name="persen_desa_kelurahan_uci" placeholder="" disabled="">
                </div>
              </div>                  
          ...
          <div class="box-footer">
            ...
            <router-link to="/table37"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
    <!-- /.modal -->
...
export default {
  ...
  methods: {
    ...
    persenUCI: function() {      
      this.DESA_KELURAHAN_PERSEN = 
        parseInt((this.DESA_KELURAHAN_UCI == '') ? 0 : this.DESA_KELURAHAN_UCI)/
        parseInt((this.JUMLAH_DESA_KELUARAHAN == '') ? 0 : this.JUMLAH_DESA_KELUARAHAN)*100;
    },          
    ...
    checkData: function(data) {
      ...
      Object.keys(myArray).forEach(element => {
        ...
        this.$http.get(this.$urlNode + '/table/getField?var=' + element + '&thn='+this.PILIH_TAHUN+'&bln=' + this.PILIH_BULAN + '&username=' + this.USERNAME + '&id_desa=' + this.ID_DESA)
          ...
          .then(() => {
            if(this.DESA_KELURAHAN_PERSEN != 0) {
              this.isUpdate = true;
            }                
          })  
          .catch(function (error) {
