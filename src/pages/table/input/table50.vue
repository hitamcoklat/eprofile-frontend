        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Puskesmas Melaksanakan Kelas Ibu Hamil </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PUSKESMAS_MELAKSANAKAN_KELAS_IBU_HAMIL" name="puskesmas_melaksanakan_kelas_ibu_hamil" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Puskesmas Melaksanakan Orientasi P4K </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PUSKESMAS_MELAKSANAKAN_ORIENTASI_P4K" name="puskesmas_melaksanakan_orientasi_p4k" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Puskesmas Melaksanakan Kegiatan Kesehatan Remaja </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PUSKESMAS_MELAKSANAKAN_KEGIATAN_KESEHATAN_REMAJA" name="puskesmas_melaksanakan_kegiatan_kesehatan_remaja" placeholder="">
                </div>
              </div>                                    
            </div>
            <div class="col-md-6">                     
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Puskesmas Melaksanakan Penjaringan Kesehatan Kelas 1 </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PUSKESMAS_MELAKSANAKAN_PENJARINGAN_KESEHATAN_KELAS_1" name="puskesmas_melaksanakan_penjaringan_kesehatan_kelas_1" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Puskesmas Melaksanakan Penjaringan Kesehatan Kelas 7 dan 10 </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PUSKESMAS_MELAKSANAKAN_PENJARINGAN_KESEHATAN_KELAS_7_10" name="puskesmas_melaksanakan_penjaringan_kesehatan_kelas_7_10" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Puskesmas Melaksanakan Penjaringan Kesehatan Kelas 1,7,10 </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="PUSKESMAS_MELAKSANAKAN_PENJARINGAN_KESEHATAN_KELAS_1_7_10" name="puskesmas_melaksanakan_penjaringan_kesehatan_kelas_1_7_10" placeholder="">
                </div>
              </div>                            
            </div>                              
          </div>
          ...
          <div class="box-footer">
            ...
            <router-link to="/table50"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
      <!-- /.modal -->
    ...
    checkData: function(data) {
      ...
      Object.keys(myArray).forEach(element => {
        ...
        this.$http.get(this.$urlNode + '/table/getField?var=' + element + '&thn='+this.PILIH_TAHUN+'&bln=' + this.PILIH_BULAN + '&username=' + this.USERNAME + '&id_desa=' + this.ID_DESA)
          ...
          .then(() => {
            if(this.PUSKESMAS_MELAKSANAKAN_KELAS_IBU_HAMIL != 0) {
              this.isUpdate = true;
            }                
          })  
          .catch(function (error) {
