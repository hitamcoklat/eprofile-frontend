      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <div class="alert alert-info alert-dismissible">
            ...
            <h4>Tabel 69 - PELAYANAN KESEHATAN PENDERITA DIABETES MELITUS (DM) MENURUT KECAMATAN DAN PUSKESMAS </h4>
        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label for="" class="col-sm-6 control-label">Jumlah Penderita DM</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="" v-model="JUMLAH_PENDERITA_DM" v-on:blur="persenPenderitaDM()" name="jumlah_penderita_dm" placeholder="">
                  </div>
                </div> 
              </div>
              <div class="col-md-6">               
                <div class="form-group">
                  <label for="" class="col-sm-6 control-label">Penderita DM Yang Mendapatkan Pelayanan Kesehatan Sesuai Standar Jumlah</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" v-model="PENDERITA_DM_YANG_MENDAPAT_PELAYANAN_KESEHATAN_SESUAI_STANDAR_JUMLAH" id="" name="penderita_dm_yang_mendapatkan_pelayanan_kesehatan_sesuai_standar_jumlah" v-on:blur="persenPenderitaDM()" placeholder="">
                  </div>
                </div> 
                <div class="form-group">
                  <label for="" class="col-sm-6 control-label">Penderita DM Yang Mendapatkan Pelayanan Kesehatan Sesuai Standar Persen</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" id="" v-model="PENDERITA_DM_YANG_MENDAPAT_PELAYANAN_KESEHATAN_SESUAI_STANDAR_PERSEN" name="penderita_dm_yang_mendapatkan_pelayanan_kesehatan_sesuai_standar_persen" disabled="" placeholder="">
                  </div>
                </div> 
              </div>                                         
            </div>                                               
          ...
          <div class="box-footer">
            ...
            <router-link to="/table69"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
      <!-- /.modal -->
...
export default {
  ...
  data() {
    return {
      ...
      PENDERITA_DM_YANG_MENDAPAT_PELAYANAN_KESEHATAN_SESUAI_STANDAR_JUMLAH: 0,
      PENDERITA_DM_YANG_MENDAPAT_PELAYANAN_KESEHATAN_SESUAI_STANDAR_PERSEN: 0,
  ...
  methods: {
    ...
    persenPenderitaDM: function() {      
      this.PENDERITA_DM_YANG_MENDAPAT_PELAYANAN_KESEHATAN_SESUAI_STANDAR_PERSEN = 
        parseInt((this.PENDERITA_DM_YANG_MENDAPAT_PELAYANAN_KESEHATAN_SESUAI_STANDAR_JUMLAH == '') ? 0 : this.PENDERITA_DM_YANG_MENDAPAT_PELAYANAN_KESEHATAN_SESUAI_STANDAR_JUMLAH)/
        parseInt((this.JUMLAH_PENDERITA_DM == '') ? 0 : this.JUMLAH_PENDERITA_DM)*100;
    },              
