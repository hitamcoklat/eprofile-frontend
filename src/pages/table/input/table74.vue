      ...
      <div class="box box-info">
        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="persenSTBMDesa()" v-model="JUMLAH_DESA_KELURAHAN" name="jumlah_desa_kelurahan" placeholder="">
                </div>
              </div> 
              <div class="form-group">
                <span class="badge bg-green"> Sanitasi Total Berbasis Masyarakat (STBM) </span>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Desa Melaksanakan STBM Jumlah </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="persenSTBMDesa()" v-model="STBM_DESA_MELAKSANAKAN_STBM_JUMLAH" name="stbm_desa_melaksanakan_stbm_jumlah" placeholder="">
                </div>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Desa Melaksanakan STBM Persen </label>
                <div class="col-sm-4">
                  <input disabled type="text" class="form-control" id="" v-model="STBM_DESA_MELAKSANAKAN_STBM_PERSEN" name="stbm_desa_melaksanakan_stbm_persen" placeholder="">
                </div>
              </div> 
            </div>
            <div class="col-sm-6">
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Desa Stop BABS (SBS) Jumlah </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="persenSTBMsbs()" v-model="STBM_DESA_STOP_BABS_SBS_JUMLAH" name="stbm_desa_stop_babs_sbs_jumlah" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Desa Stop BABS (SBS) Persen </label>
                <div class="col-sm-4">
                  <input disabled type="text" class="form-control" id="" v-model="STBM_DESA_STOP_BABS_SBS_PERSEN" name="stbm_desa_stop_babs_sbs_persen" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Desa STBM Jumlah </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="persenSTBMdesaSTBM()" v-model="STBM_DESA_STBM_JUMLAH" name="stbm_desa_stbm_jumlah" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Desa STBM Persen </label>
                <div class="col-sm-4">
                  <input disabled type="text" class="form-control" id="" v-model="STBM_DESA_STBM_PERSEN" name="stbm_desa_stbm_persen" placeholder="">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="box-footer">
            ...
            <router-link to="/table74"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
      <!-- /.modal -->
...
export default {
  ...
  methods: {
    ...
    persenSTBMDesa: function() {      
      this.STBM_DESA_MELAKSANAKAN_STBM_PERSEN = 
        parseInt((this.STBM_DESA_MELAKSANAKAN_STBM_JUMLAH == '') ? 0 : this.STBM_DESA_MELAKSANAKAN_STBM_JUMLAH)/
        parseInt((this.JUMLAH_DESA_KELURAHAN == '') ? 0 : this.JUMLAH_DESA_KELURAHAN)*100 ;    
    },
    persenSTBMsbs: function() {      
      this.STBM_DESA_STOP_BABS_SBS_PERSEN = 
        parseInt((this.STBM_DESA_MELAKSANAKAN_STBM_JUMLAH == '') ? 0 : this.STBM_DESA_MELAKSANAKAN_STBM_JUMLAH)/
        parseInt((this.JUMLAH_DESA_KELURAHAN == '') ? 0 : this.JUMLAH_DESA_KELURAHAN)*100 ;    
    }, 
    persenSTBMdesaSTBM: function() {      
      this.STBM_DESA_STBM_PERSEN = 
        parseInt((this.STBM_DESA_MELAKSANAKAN_STBM_JUMLAH == '') ? 0 : this.STBM_DESA_MELAKSANAKAN_STBM_JUMLAH)/
        parseInt((this.JUMLAH_DESA_KELURAHAN == '') ? 0 : this.JUMLAH_DESA_KELURAHAN)*100 ;    
    },    
    ...
    checkData: function(data) {
      ...
      Object.keys(myArray).forEach(element => {
        ...
        this.$http.get(this.$urlNode + '/table/getField?var=' + element + '&thn='+this.PILIH_TAHUN+'&bln=' + this.PILIH_BULAN + '&username=' + this.USERNAME + '&id_desa=' + this.ID_DESA)
          ...
          .then(() => {
            if(this.STBM_DESA_STOP_BABS_SBS_JUMLAH != 0) {
              this.isUpdate = true;
            }                
          })  
          .catch(function (error) {
