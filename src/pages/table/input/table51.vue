        ...
        <form class="form-horizontal">
          <div class="box-body">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Jumlah Tuberkulosis Yang Mendapatkan Pelayanan Sesuai Standar </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="JUMLAH_TERDUGA_TUBERKOLOSIS_YANG_MENDAPATKAN_PELAYANAN_SESUAI_STANDAR" name="jumlah_tuberkulosis_yang_mendapatkan_pelayanan_sesuai_standar" placeholder="">
                </div>
              </div>             
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Semua Kasus Tuberkulosis Laki-Laki Jumlah </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="jmlSemuaKasusTBLP()" v-model="JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_JUMLAH" name="jumlah_semua_kasus_tuberkulosis_laki_laki_jumlah" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Jumlah Semua Kasus Tuberkulosis Perempuan Jumlah </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-on:blur="jmlSemuaKasusTBLP()" v-model="JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_PEREMPUAN_JUMLAH" name="jumlah_semua_kasus_tuberkulosis_perempuan_jumlah" placeholder="">
                </div>
              </div>
            </div>
            <div class="col-md-6">                     
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Semua Kasus Tuberkulosis Laki+Perempuan </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_PEREMPUAN" name="jumlah_semua_kasus_tuberkulosis_laki_perempuan" placeholder="" disabled="">
                </div>
              </div> 
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Semua Kasus Tuberkulosis Laki-Laki Persen </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_PERSEN" name="jumlah_semua_kasus_tuberkulosis_laki_laki_persen" placeholder="" disabled="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label">Jumlah Semua Kasus Tuberkulosis Perempuan Persen </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_PEREMPUAN_PERSEN" name="jumlah_semua_kasus_tuberkulosis_perempuan_persen" placeholder="" disabled="">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-6 control-label"> Kasus TUberkulosis Anak 0-14 </label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" id="" v-model="KASUS_TUBERKOLOSIS_ANAK_0_14_TAHUN" name="kasus_tuberkulosis_anak_0_14_tahun" placeholder="">
                </div>
              </div>
          ...
          <div class="box-footer">
            ...
            <router-link to="/table51"><a class="btn btn-success btn-md"><i class="fa fa-fw fa-arrow-left"></i> Kembali</a></router-link>
          </div>
          <!-- /.box-footer -->
        </form>            
      <!-- /.modal -->
...
export default {
  ...
  methods: {
    ...
    jmlSemuaKasusTBLP: function() {      
      this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_PEREMPUAN = 
        parseInt((this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_JUMLAH == '') ? 0 : this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_JUMLAH)+
        parseInt((this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_PEREMPUAN_JUMLAH == '') ? 0 : this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_PEREMPUAN_JUMLAH); 

      this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_PERSEN = 
        parseInt((this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_JUMLAH == '') ? 0 : this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_JUMLAH)/
        parseInt((this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_PEREMPUAN == '') ? 0 : this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_PEREMPUAN)*100; 

      this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_PEREMPUAN_PERSEN = 
        parseInt((this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_PEREMPUAN_JUMLAH == '') ? 0 : this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_PEREMPUAN_JUMLAH)/
        parseInt((this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_PEREMPUAN == '') ? 0 : this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_PEREMPUAN)*100;    
    ...
    checkData: function(data) {
      ...
      Object.keys(myArray).forEach(element => {
        ...
        this.$http.get(this.$urlNode + '/table/getField?var=' + element + '&thn='+this.PILIH_TAHUN+'&bln=' + this.PILIH_BULAN + '&username=' + this.USERNAME + '&id_desa=' + this.ID_DESA)
          ...
          .then(() => {
            if(this.JUMLAH_SEMUA_KASUS_TUBERKOLOSIS_LAKI_LAKI_JUMLAH != 0) {
              this.isUpdate = true;
            }                
          })  
          .catch(function (error) {
